...
uint256 hashGenesisBlock("0xaf9fde5767ab1a2c79ce3e93d48656bd1585abf01f070f60637ef4fc43a1fdc5");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(505414808); // Sharcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Sharcoin Signed Message:\n";
...
{
    // Sharcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 440000); // Sharcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 151200; // Sharcoin: 3.5 days
static const int64 nTargetSpacing = 75; // Sharcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Sharcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Sharcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Sharcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa5eb6592d4c8cc243caa0d1daea7283867196729a98f27cae196f053efc553e7");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "I am the founder of Kickers.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 2500000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("a46425d20dbad30eb89c3c433fad71999f5ba0b4d78020c89cdb4fd7ccb6e466cd84b931b88301bf786f4ca19eb2561f731fbcdd7a35f80c0280d753077cb37575") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1513079038;
        block.nBits    = 505414808;
        block.nNonce   = 2108651861;

        if (fTestNet)
        {
            block.nTime    = 1513079038;
            block.nNonce   = 4138120099;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2e9eab8dd5b301ccef8a0b620e27da27c858dfa74162fa25bece497f920ceab8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Sharcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SharcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SharcoinMiner : ProcessBlock, block not accepted");
    }
